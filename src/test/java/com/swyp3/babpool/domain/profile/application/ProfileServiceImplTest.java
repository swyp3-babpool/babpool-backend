    ...
    void updatePossibleDateTime() {
        ...
        List<PossibleDateAndTime> existPossibleDateTimeLists = List.of(
                PossibleDateAndTime.builder()
                        ...
                        .possibleTimeIdGroupConcat("111,222,333")
                        .possibleTimeGroupConcat("1,2,3")
                        .build(),
                PossibleDateAndTime.builder()
                        .possibleDateId(1L)
                        .possibleDate("2024-03-15")
                        .possibleTimeIdGroupConcat("444,555,666,777")
                        .possibleTimeGroupConcat("1,2,3,7")
                        .build()
                ,
                PossibleDateAndTime.builder()
                        .possibleDateId(1L)
                        .possibleDate("2024-03-16")
                        .possibleTimeIdGroupConcat("777")
                        .possibleTimeGroupConcat("7")
                        .build()
        );
