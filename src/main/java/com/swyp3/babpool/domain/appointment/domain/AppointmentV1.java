...
public class AppointmentV1 {
    ...
    @Builder
    public AppointmentV1(Long appointmentId, Long appointmentSenderId, Long appointmentReceiverId, Long possibleDateTimeId, String appointmentStatus, String appointmentQuestion, LocalDateTime appointmentCreateDate, LocalDateTime appointmentModifyDate) {
